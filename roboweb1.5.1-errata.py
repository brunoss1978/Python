...
#fornecer para a gente o arquivo de saida para um arquivo
arquivoDeSaida = open('Resultado.txt', 'w')
...
#contagem de celulas começando da linha zero     
    ...
    texto = 'O dominio %s %s\n' %(cont, driver.find_elements(By.XPATH, '//*[@id="app"]/main/section/div[2]/div/p/span/strong').text)
